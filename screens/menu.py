...
class MenuScreen(Screen):
    def __init__(self):
        super().__init__()
        self.add(InfoBox(20, 80, 200, 62, "01", lambda d: "DASHBOARD", theme.CYAN))
        self.add(InfoBox(260, 80, 200, 62, "02", lambda d: "SYSTEM", theme.GREEN))
        self.add(InfoBox(20, 160, 200, 62, "03", lambda d: "NAVIGATION", theme.YELLOW))
        self.add(InfoBox(260, 160, 200, 62, "04", lambda d: "MOTOR", theme.ORANGE))
