...
class DashboardV2(Screen):
    def __init__(self):
        super().__init__()
        self.add(InfoBox(8, 242, 148, 68, "KRANGNING", lambda d: f"{d['roll']:5.1f}°"))
        self.add(InfoBox(166, 242, 148, 68, "STAMPNING", lambda d: f"{d['pitch']:5.1f}°"))
        self.add(InfoBox(324, 242, 148, 68, "BATTERI", lambda d: f"{d.get('battery', {}).get('voltage', 0):.1f} V"))
